...
eroded = imerode(image_bordered, EE);
% dilated = imdilate(dilated,EE);
% eroded = imerode(dilated,EE);
% dilated = imdilate(eroded,EE);
% eroded = imerode(dilated,EE);
% filled = imfill(eroded, "holes");
% image_bordered = edge(filled, "Prewitt");
% f = bwmorph(image_bordered, "thin", Inf);
